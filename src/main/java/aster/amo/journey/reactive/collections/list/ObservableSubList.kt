...
import aster.amo.journey.reactive.collections.ObservableCollection
...
open class ObservableSubList<T>(
    ...
    fun mutableCopy(): MutableObservableCollection<T, List<T>> {
        return MutableObservableSubList(
            parentList.mutableCopy(), // Create a copy of the parent list
            fromIndex,
            toIndex,
            elementHandler
        )
